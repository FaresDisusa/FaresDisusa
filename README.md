...
* **Advanced ML Architecture:** The current big idea I'm experimenting with is a system with a **meta-model** that manages a ensemble of specialized **expert models**. The goal is to let the system pick the best model for whatever the market is doing at the moment.
...
Aside from my main project, I'm also deeply interested in:
